    ...
    public partial class SeedData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AlterColumn<DateTime>(
                ...
                oldType: "datetime2",
                oldDefaultValue: new DateTime(2024, 4, 23, 7, 10, 23, 228, DateTimeKind.Utc).AddTicks(8972));
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("1ce6918e-f21f-494b-aa5e-cb26a78a5b3e"), null, "Customer role for individuals interested in booking workouts and viewing schedules.", "Customer", null },
                    { new Guid("5228b6f2-322a-4554-a534-e3cc61cbcc68"), null, "Administrator role with full access to system functionalities.", "Admin", null },
                    { new Guid("eae5654b-fd83-4e58-b380-e10eb18498c1"), null, "Trainer role responsible for creating and managing workouts, schedules, and user interactions.", "Trainer", null }
                });
            ...
            migrationBuilder.InsertData(
                table: "LocationsWorkouts",
                columns: new[] { "LocationsId", "WorkoutsId" },
                values: new object[,]
                {
                    { new Guid("753ed14c-c702-445e-8f3d-8c08f843e7be"), new Guid("65283b8b-ffc4-4893-9d5e-040b3270ac91") },
                    { new Guid("d887a48c-5163-45cf-b097-39f3e1bba52e"), new Guid("fa405850-875f-402d-9f57-72712d702a3f") }
                });

            migrationBuilder.InsertData(
                table: "Schedules",
                columns: new[] { "Id", "Capacity", "Date", "LocationId", "UserId" },
                values: new object[,]
                {
                    { new Guid("353070a1-6234-4341-be19-4e9c28cfdb16"), 10, new DateTime(2024, 6, 25, 8, 0, 0, 0, DateTimeKind.Unspecified), new Guid("753ed14c-c702-445e-8f3d-8c08f843e7be"), new Guid("34beea57-664e-418c-88c5-5fad2d0a10df") },
                    { new Guid("62829231-8f59-4316-b7b5-70ce7e309008"), 5, new DateTime(2024, 6, 27, 19, 0, 0, 0, DateTimeKind.Unspecified), new Guid("753ed14c-c702-445e-8f3d-8c08f843e7be"), new Guid("34beea57-664e-418c-88c5-5fad2d0a10df") }
                });

            migrationBuilder.InsertData(
                table: "TrainersWorkouts",
                columns: new[] { "TrainersId", "WorkoutsId" },
                values: new object[,]
                {
                    { new Guid("34beea57-664e-418c-88c5-5fad2d0a10df"), new Guid("65283b8b-ffc4-4893-9d5e-040b3270ac91") },
                    { new Guid("34beea57-664e-418c-88c5-5fad2d0a10df"), new Guid("fa405850-875f-402d-9f57-72712d702a3f") }
                });
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DeleteData(
                table: "LocationsWorkouts",
                keyColumns: new[] { "LocationsId", "WorkoutsId" },
                keyValues: new object[] { new Guid("753ed14c-c702-445e-8f3d-8c08f843e7be"), new Guid("65283b8b-ffc4-4893-9d5e-040b3270ac91") });

            migrationBuilder.DeleteData(
                table: "LocationsWorkouts",
                keyColumns: new[] { "LocationsId", "WorkoutsId" },
                keyValues: new object[] { new Guid("d887a48c-5163-45cf-b097-39f3e1bba52e"), new Guid("fa405850-875f-402d-9f57-72712d702a3f") });
            ...
            migrationBuilder.DeleteData(
                table: "TrainersWorkouts",
                keyColumns: new[] { "TrainersId", "WorkoutsId" },
                keyValues: new object[] { new Guid("34beea57-664e-418c-88c5-5fad2d0a10df"), new Guid("65283b8b-ffc4-4893-9d5e-040b3270ac91") });

            migrationBuilder.DeleteData(
                table: "TrainersWorkouts",
                keyColumns: new[] { "TrainersId", "WorkoutsId" },
                keyValues: new object[] { new Guid("34beea57-664e-418c-88c5-5fad2d0a10df"), new Guid("fa405850-875f-402d-9f57-72712d702a3f") });
            ...
            migrationBuilder.AlterColumn<DateTime>(
                ...
                type: "datetime2",
                nullable: false,
                defaultValue: new DateTime(2024, 4, 23, 7, 10, 23, 228, DateTimeKind.Utc).AddTicks(8972),
                oldClrType: typeof(DateTime),
                oldType: "datetime2",
